...
class database{
	...
	{
		$data = mysqli_query($this->koneksi,"select * from tb_member");
	...
	// Clas proses data
	function input($nama,$alamat,$no_telpon){
		mysqli_query($this->koneksi,"insert into user values ('','$nama','$alamat','$no_telpon')");
	}
